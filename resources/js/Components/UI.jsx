        ...
        <div className={`p-4 rounded-xl border ${styles.bg} ${styles.border} ${styles.text}`}>
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                    {title && <div className="font-semibold mb-1">{t(title)}</div>}
                    <div className="text-sm opacity-90">{t(children)}</div>
                </div>
                {onClose && (
                    <button
                        onClick={onClose}
...
export function EmptyState({
    ...
    return (
        <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-(--color-text-primary) mb-2">{t(title)}</h3>
            {description && (
                <p className="text-(--color-text-tertiary) text-sm mb-4">{t(description)}</p>
            )}
            {action}
        </div>
    );
...
export function LoadingState({ message = 'Loading...' }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center py-12">
            ...
            <span className="text-(--color-text-tertiary)">{t(message)}</span>
        </div>
    );
}
