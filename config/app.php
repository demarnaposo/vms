...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | VendorFlow Operational Settings
    |--------------------------------------------------------------------------
    */

    'notifications_expire_read_days' => (int) env('NOTIFICATIONS_EXPIRE_READ_DAYS', 30),
    'notifications_expire_unread_days' => (int) env('NOTIFICATIONS_EXPIRE_UNREAD_DAYS', 90),
